	...
	<tbody>
		...
		<tr>
			...
			<td>
				Matériel:
					<?php
						if($donnee_intervention['materiel'] == 1){echo "Pc Fixe";}
						if($donnee_intervention['materiel'] == 2){echo "Pc Portable";}
						if($donnee_intervention['materiel'] == 9){echo "Autre";}
					?><br>
			...
			<td>
				<a href="modif.inter.php?idintervention=<?php echo $donnee_intervention['idintervention']; ?>" class="btn btn-default btn-sm btn-icon icon-left">
					<i class="entypo-pencil"></i>
					Editer
				</a>
				
				<a href="supp.inter.php?idintervention=<?php echo $donnee_intervention['idintervention']; ?>" class="btn btn-danger btn-sm btn-icon icon-left">
					<i class="entypo-cancel"></i>
					Supprimé
				</a>
				
				<a href="<?php echo $rootsite; ?>/pdf/fiche_intervention.php?idintervention=<?php echo $donnee_intervention['idintervention']; ?>" class="btn btn-info btn-sm btn-icon icon-left">
