...
$req = "INSERT INTO `lsiinforinter`.`intervention` (`idintervention`, `idclient`, `date`, `mode_reglement`, `date_maintenance_prevue`, `materiel`, `marque`, `serie`, `num_serie`, `accessoire`, `desc_probleme`, `desc_soluce`, `idtechnicien`, `garantie`, `date_achat`, `etat_materiel`, `etat_intervention`, `cnt`, `idcnt`) 
